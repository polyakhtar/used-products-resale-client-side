            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                  <button className=" px-20 py-3 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto lg:mx-4 hover:bg-blue-700 focus:outline-none focus:bg-blue-500">
                  Buy
                  </button>
                </div>
              </div>

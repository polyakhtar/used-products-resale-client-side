...
const Banner = () => {
    return (
        <div className="hero bg-blue-300 py-16 mb-6">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className='w-1/2  mr-16'>
            ...
            <p className="py-6 text-lg font-semibold">By using this platform ,You can buy or sale any used mobile phones and the quality of phone is very good.</p>
          </div>
        </div>
      </div>
    );
